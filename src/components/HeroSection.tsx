  ...
  return (
    <section className="relative overflow-hidden">
      <div className="relative pt-28 pb-20 lg:pt-36 lg:pb-28">
        ...
        {/* Radar rings */}
        <div className="absolute inset-0 top-20 flex items-center justify-center pointer-events-none" aria-hidden="true">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-xs font-accent font-semibold uppercase tracking-[0.2em] text-primary">Client Closing Intelligence</span>
              <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold leading-[1.08] text-foreground text-3d-matte">
              Close Your First{' '}
              <span className="text-gradient-animated">₹1 Lakh Client</span>
              <br />
            ...
            <p className="mt-5 text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
              ...
              <span className="text-foreground font-semibold">1,200+ are bleeding ₹50K–₹5L/month</span>. Find them in 60 seconds.
            </p>

            {/* Rotating text */}
            <div className="mt-4 h-7 flex items-center justify-center">
              <span className="text-sm text-primary font-semibold">
                ✦ <span key={textIndex} className="inline-block">{rotatingTexts?.[textIndex]}</span>
              </span>
            </div>
            ...
            <p className="mt-3 text-xs font-semibold text-primary">From ₹1,499/mo · Close your first client this week</p>
            <p className="mt-6 text-xs text-muted-foreground/60">🟢 1,200+ agencies already closing clients with LeadSutra</p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mt-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">Close your first client in days</span>
              </div>
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-accent">
                  <path d="M21.801 10A10 10 0 1 1 17 3.335" />
                ...
                <span className="text-xs text-muted-foreground">Works for agencies, freelancers &amp; consultants</span>
              </div>
            </div>
          </div>
        </div>
